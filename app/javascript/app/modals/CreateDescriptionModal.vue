        ...
        <div v-if="word" class="fields">
          <div class="form-group" :class="{ 'has-error': errors.text }">
            <slot name="word" :word="word">
              <label class="is-sentence"> Enunciado: </label>
              <span class="input">
    ...
    async submit() {
      ...
      const dataForm = {
        question_description: {
          ...
          audio: payload.word.audios_attributes
        },
      };

      dataForm.question_description = omit(dataForm.question_description, unpermitted_params);
